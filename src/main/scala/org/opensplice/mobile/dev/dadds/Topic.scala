...
object Topic  {
  ...
  def apply[T]()( implicit m: Manifest[T], dp: DomainParticipant ): org.omg.dds.topic.Topic[T] = {
    dp.createTopic( manifest[T].runtimeClass.getName(), manifest[T].runtimeClass ).asInstanceOf[org.omg.dds.topic.Topic[T]]
  }
