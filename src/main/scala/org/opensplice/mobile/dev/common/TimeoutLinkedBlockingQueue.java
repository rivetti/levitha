 ...
 * 
 */
public class TimeoutLinkedBlockingQueue<E> extends AbstractQueue<E> implements
	 ...
	 */
	public TimeoutLinkedBlockingQueue() {
	 ...
	 */
	public TimeoutLinkedBlockingQueue(int capacity) {
		if (capacity <= 0)
	 ...
	 */
	public TimeoutLinkedBlockingQueue(Collection<? extends E> c) {
		this(Integer.MAX_VALUE);
		final ReentrantLock putLock = this.putLock;
	...
	public E takeNanos(long nanosTimeout) throws InterruptedException {
		E x = null;
		int c = -1;
		final AtomicInteger count = this.count;
		final ReentrantLock takeLock = this.takeLock;
